...
(function() {
    var provider = app.data.antskeleton = new Everlive({
            offlineStorage: true,
            appId: 'v3bk9ume6rgbr5en',
            scheme: 'https',
            authentication: {
                persist: true
            }
        }),
        accessTokenCacheKey = 'antskeleton_access_token',
...
// START_CUSTOM_CODE_antskeleton
// Add custom code here. For more information about custom code, see http://docs.telerik.com/platform/screenbuilder/troubleshooting/how-to-keep-custom-code-changes

// END_CUSTOM_CODE_antskeleton